...
const db = mysql.createConnection({
  host: 'localhost',
  port: 3307, // Ensure this port is correct for your setup
  user: 'root',
  password: 'root', // IMPORTANT: Use your real password
  database: 'ecesports'
});
...
db.connect((err) => {
  ...
  console.log('✅ Connected to the `ecesports` MySQL database.');
});
